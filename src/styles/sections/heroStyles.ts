export const heroStyles = {
  root: {
    base: "min-h-screen lg:min-h-[800px] w-full px-8 py-16 lg:py-20 flex items-center justify-center bg-gradient-to-b from-transparent from-30% to-secondary-900/50",
  },
  container: {
