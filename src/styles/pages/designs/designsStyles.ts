export const designsStyles = {
  ...
  tabMenu: {
    ...
    item: {
      base: "!bg-transparent !text-current text-sm xs:text-base !px-1 border-2 border-b-4 !border-x-transparent !border-t-transparent rounded-none whitespace-nowrap",
